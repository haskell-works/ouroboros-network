...
import           Ouroboros.Consensus.Cardano.Node (ProtocolParamsAllegra (..),
              ...
              , tniProtocolInfo =
                  protocolInfoShelleyAllegra
                    ProtocolParamsShelley {
                      ...
                      , shelleyInitialNonce      = setupInitialNonce
                      , shelleyProtVer           = SL.ProtVer majorVersion1 0
                      , shelleyLeaderCredentials = Identity $
                          Shelley.mkLeaderCredentials (coreNodes !! fromIntegral nid)
                      }
                    ProtocolParamsAllegra {
                        allegraProtVer           = SL.ProtVer majorVersion2 0
                      , allegraLeaderCredentials = Identity $
                          Shelley.mkLeaderCredentials (coreNodes !! fromIntegral nid)
                      }
